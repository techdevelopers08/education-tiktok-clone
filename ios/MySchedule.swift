...
let schedule = DeviceActivitySchedule(
    ...
    intervalStart: DateComponents(hour: 23, minute: 05),
    intervalEnd: DateComponents(hour: 10, minute: 05),
...
//        ManagedSettingsStore().shield.applications = MyModel.shared.selectionToDiscourage.applicationTokens
        do {
